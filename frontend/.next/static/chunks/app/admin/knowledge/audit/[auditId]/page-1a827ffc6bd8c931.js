(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [675],
  {
    83080: function (e, t, s) {
      Promise.resolve().then(s.bind(s, 1051));
    },
    1051: function (e, t, s) {
      "use strict";
      (s.r(t),
        ...
        let m = async () => {
          ...
          try {
            let e = localStorage.getItem("adminToken"),
              r = await fetch("/api/admin/knowledge/audit/".concat(t.auditId), {
                  ...
                  children: [
                    (0, r.jsx)("div", {
                      ...
                      children: (0, r.jsxs)("div", {
                        ...
                        children: [
                          (0, r.jsx)("button", {
                            onClick: () => s.push("/admin/knowledge/audit"),
                            className:
                              ...
                              children: [
                                (0, r.jsxs)("div", {
                                  children: [
                                    ...
                                    (0, r.jsx)("div", {
                                      className:
                                        "inline-block px-3 py-1 rounded-md border font-semibold ".concat(
                                          ((e) => {
                                            switch (e) {
                                              case "CREATE":
                                ...
                                (0, r.jsxs)("div", {
                                  children: [
                                    ...
                                    (0, r.jsx)("div", {
                                      ...
                                      children: d.entityType.replace("_", " "),
                                    }),
                                  ],
                                }),
                                (0, r.jsxs)("div", {
                        ...
                        "UPDATE" === d.action &&
                          ...
                          (0, r.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, r.jsx)("div", {
                                className: "space-y-4",
                                children: Object.entries(d.diffJson).map(
                                  (e) => {
                                    let [t, s] = e;
                                    return (0, r.jsxs)(
                                      "div",
                          ...
                          (0, r.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, r.jsx)("pre", {
                                ...
                                children: JSON.stringify(d.beforeJson, null, 2),
                              }),
                            ],
                          }),
                        "DELETE" !== d.action &&
                          ...
                          (0, r.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, r.jsx)("pre", {
                                className:
                                  "bg-gray-50 border border-gray-200 rounded p-4 text-sm overflow-x-auto",
                                children: JSON.stringify(d.afterJson, null, 2),
                              }),
                            ],
                          }),
                      ],
      ...
      function i(e) {
        ...
        let u = async (e) => {
            try {
              ...
              t.ok ? i(!0) : localStorage.removeItem("adminToken");
            } catch (e) {
              i(!0);
            } finally {
              l(!1);
          ...
          h = async (e) => {
            ...
            try {
              ...
              e.ok
                ? (localStorage.setItem("adminToken", o), i(!0), c(""))
                ...
                children: [
                  (0, r.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, r.jsx)("button", {
                        onClick: () => {
                          (localStorage.removeItem("adminToken"), i(!1), c(""));
                        },
                        className:
