      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            >
              Care2Connect gives people experiencing homelessness the digital
              tools to market themselves for support—just like modern
              advertising, but for human connection and opportunity.
            </motion.p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              To empower individuals experiencing homelessness with the same
              powerful digital marketing tools that businesses use, helping them
              tell their story and connect with supporters who can help.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl text-gray-600 max-w-3xl mx-auto"
            >
              Our platform helps you create a professional fundraising presence
              in minutes
            </motion.p>
          </motion.div>
          ...
          >
            {[
              ...
              >
                <div
                  className={`w-16 h-16 bg-${step.color}-100 rounded-lg flex items-center justify-center mb-4`}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl text-gray-600 max-w-3xl mx-auto"
            >
              Coming soon: An intelligent assistant to help you navigate
          ...
          >
            {[
              ...
              >
                <div
                  className={`w-16 h-16 bg-${feature.color}-100 rounded-lg flex items-center justify-center mb-4`}
                >
                  <feature.icon
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Whether you need help or want to support someone, Care2Connect is
              here for you
            </p>
