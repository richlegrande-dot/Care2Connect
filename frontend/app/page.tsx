...
import { MicrophoneIcon, HeartIcon, BriefcaseIcon, MapPinIcon, ShieldCheckIcon, UsersIcon, ServerIcon, CheckCircleIcon } from '@heroicons/react/24/outline'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50">
      ...
      <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white py-2.5 px-4 text-center text-sm font-semibold border-b-2 border-blue-700 shadow-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="hidden sm:inline text-xs text-blue-200">Powered by Local Services</span>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-900 rounded-full text-sm font-bold mb-6 border border-blue-200">
                  ...
                  <span>A collaboration between local government and community partners</span>
                </div>
                ...
                <div className="space-y-4 mb-8">
                  <h3 className="font-bold text-gray-900 text-lg">What You Can Do:</h3>
                  
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Share Your Story</h4>
                      <p className="text-sm text-gray-600">Record your voice to help others understand your journey</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Get Support Tools</h4>
                      <p className="text-sm text-gray-600">Create QR codes and fundraising materials</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Connect with Community</h4>
                      <p className="text-sm text-gray-600">Make it easy for people to help you</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="w-56 h-56 bg-gradient-to-br from-red-600 to-red-700 rounded-full flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 border-4 border-white animate-breathing">
                      <div className="text-center text-white px-4">
                        ...
                        <div className="font-extrabold text-base leading-tight tracking-wider">
                          PRESS TO<br />TELL YOUR<br />STORY
                        </div>
                      </div>
                    </div>
                ...
                <div className="mt-8 text-center max-w-xs">
                  <p className="text-sm text-gray-600 font-medium leading-relaxed">
                    You're in control. You can stop at any time.<br />
                    <span className="text-gray-800">Your story helps connect you with support and resources.</span>
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">How CareConnect Helps</h3>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">transcription with native language support creates
              Our platform provides comprehensive support through technology, compassion, and community connection.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Fundraising & Support Tools</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <h4 className="text-xl font-bold text-center mb-3">Record Your Story</h4>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <h4 className="text-xl font-bold text-center mb-3">GoFundMe Creator</h4>
              <p className="text-gray-600 text-center mb-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <h4 className="text-xl font-bold text-center mb-3">QR Code Donations</h4>
              <p className="text-gray-600 text-center mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
            <div className="col-span-2">
              <h4 className="text-lg font-semibold mb-4 gradient-text">CareConnect</h4>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/tell-story" className="hover:text-gray-900">Share Your Story</Link></li>
                <li><Link href="/resources" className="hover:text-gray-900">Find Resources</Link></li>
                <li><Link href="/jobs" className="hover:text-gray-900">Job Search</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/browse-profiles" className="hover:text-gray-900">Support Someone</Link></li>
                <li><Link href="/volunteer" className="hover:text-gray-900">Volunteer</Link></li>
                <li><Link href="/organizations" className="hover:text-gray-900">Partner With Us</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/health" className="hover:text-gray-900">System Health</Link></li>
                <li><Link href="/admin/knowledge" className="hover:text-gray-900">Knowledge Vault</Link></li>
                <li><Link href="/admin/knowledge/incidents" className="hover:text-gray-900">Pipeline Incidents</Link></li>
                <li><Link href="/admin/knowledge/audit" className="hover:text-gray-900">Audit Logs</Link></li>
              </ul>
            </div>
          </div>
