...
export const FileStore = {
  saveAnalysis: (analysis: any) => {
    appendJsonLine("analysis.jsonl", {
      ...analysis,
      _savedAt: new Date().toISOString(),
    });
  },
  saveDonation: (donation: any) => {
    appendJsonLine("donations.jsonl", {
      ...donation,
      _savedAt: new Date().toISOString(),
    });
  },
  updateDonationStatus: (sessionId: string, updates: any) => {
    ...
    appendJsonLine("donations-updates.jsonl", {
      sessionId,
      ...updates,
  ...
  saveSupportTicket: (ticket: any) => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        { ...ticket, _savedAt: new Date().toISOString() },
        null,
        2,
      ),
      "utf8",
