...
describe('FollowUpQuestionModal Component', () => {
  ...
  describe('Modal Rendering', () => {
    ...
    it('should show the first question by default', () => {
      ...
      expect(screen.getByText(mockFollowUpQuestions[0].question)).toBeInTheDocument();
      expect(screen.getByText(mockFollowUpQuestions[0].context)).toBeInTheDocument();
    });
  });
  ...
  describe('Question Navigation', () => {
    it('should navigate to next question when answered', async () => {
      ...
      expect(screen.getByText(mockFollowUpQuestions[1].question)).toBeInTheDocument();
  ...
  describe('Answer Input Methods', () => {
    ...
    it('should handle dynamic suggestions with placeholders', async () => {
      ...
      expect(screen.getByRole('button', { name: 'Help John Smith with Medical Bills' })).toBeInTheDocument();
    });
  });
