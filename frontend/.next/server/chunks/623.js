    ...
    82698: (e, t, r) => {
      ...
      function p({ serverHooks: e, staticGenerationAsyncStorage: t }) {
        ...
        ((globalThis.fetch = async (e, c) => {
          ...
          let _;
          try {
            (((_ = new URL(e instanceof Request ? e.url : e)).username = ""),
              (_.password = ""));
          } catch {
            _ = void 0;
          }
          ...
          return await (0, a.getTracer)().trace(
            ...
            async () => {
              ...
              let E = (t) => {
                  var r, n, a;
                  return void 0 !==
                    (null == c ? void 0 : null == (r = c.next) ? void 0 : r[t])
                    ? null == c
                      ? void 0
                      : null == (n = c.next)
                        ? void 0
              ...
              let D = O("headers"),
                ...
                j = !["get", "head"].includes(
                  (null == (n = O("method")) ? void 0 : n.toLowerCase()) ||
                    "get",
                ),
                    ...
                    ("number" == typeof f &&
                      (!1 === _.revalidate ||
                        ("number" == typeof _.revalidate &&
                          f < _.revalidate)))) &&
                  (0 === f && (0, s.maybePostpone)(_, "revalidate: 0"),
                  (_.revalidate = f)));
              ...
              let U = "number" != typeof f ? o.CACHE_ONE_YEAR : f,
                H = async (t, r) => {
                  ...
                  if (b) {
                    ...
                    let e = c;
                    for (let t of ((c = { body: c._ogBody || c.body }), n))
                      c[t] = e[t];
                  }
                  let o = {
                    ...c,
      ...
      class S {
        ...
        trace(...e) {
          ...
          let _ = u.spanName ?? r,
            ...
            b = !1;
          S
            ? (null == (t = s.getSpanContext(S)) ? void 0 : t.isRemote) &&
              (b = !0)
            : ((S = c), (b = !0));
          let h = v();
          return (
