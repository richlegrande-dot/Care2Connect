...
export class NoOpAIProvider implements AIProvider {
  ...
  async generateDonationPitch(
    ...
    console.log('[NoOpAIProvider] Skipping donation pitch generation - V1 mode');
  ...
  async generateGoFundMeDraft(input: {
    ...
    if (input.formData) {
      return {
        ...
        goalAmount: input.formData.goalAmount ? parseInt(input.formData.goalAmount, 10) : undefined,
