...
export class EnhancedAmountExtractor extends EnhancedExtractor {
  ...
  private rankCandidates(candidates: AmountCandidate[], transcript: string): AmountCandidate[] {
    return candidates
  ...
  private adjustConfidence(candidate: AmountCandidate, transcript: string): number {
