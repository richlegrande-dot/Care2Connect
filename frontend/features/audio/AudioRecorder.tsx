...
export function AudioRecorder({ onRecordingComplete, onRecordingStart, onRecordingStop, maxDuration }: Props) {
  ...
  const start = async () => {
    ...
    try {
      ...
      const Recorder = (global as any).MediaRecorder || (window as any).MediaRecorder
