  ...
  const processRecording = async (chunks: Blob[]) => {
    ...
    try {
      ...
      setState((prev) => ({
        ...
        isProcessing: false,
        error:
          "Couldn't process your recording. Would you like to enter your story instead?",
      }));
    }
  };
    ...
    <div className="max-w-2xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <p className="text-gray-600 mb-8 text-center">
          Press record and tell your story. Our AI will help create your
            ...
            <div className="w-full max-w-md text-center">
              <div className="p-4 bg-green-50 border border-green-200 rounded-md">
                ...
                <p className="text-green-700 text-sm">
                  Your story has been transcribed successfully.
                </p>
        ...
        {!state.isRecording && (
          <div className="mt-8 p-4 bg-gray-50 rounded-md">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              ...
              <li>
                • Include key details: what happened, how much you need, who
                it's for
              </li>
