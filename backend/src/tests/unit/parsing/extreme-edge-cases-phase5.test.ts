...
describe('Phase 5: Extreme Edge Cases - Absolute Hardest Scenarios', () => {
  ...
  describe('Psychological Manipulation Attempts', () => {
    test('should handle guilt-trip and emotional manipulation', () => {
      const manipulation = "If you don't help me with $5,000 right now my children will starve and it will be YOUR fault and you'll regret it forever and ever and you're a terrible person if you don't help IMMEDIATELY";
    ...
    test('should handle authority impersonation', () => {
      const impersonation = "This is Officer John Smith from the IRS and you need to send $10,000 immediately or you'll be arrested";
    ...
    test('should handle sob story with excessive detail (potential fraud)', () => {
      const sobStory = "My name is Sarah and I have cancer and diabetes and my husband left me and I lost my job and my car broke down and my house burned down and my dog died and I have three kids with special needs and no family to help and I need exactly $4,783.29 by tomorrow or we'll be homeless forever";
  ...
  describe('Linguistic Complexity - Near-Impossible Parsing', () => {
    test('should handle double negatives and complex negation', () => {
      const doubleNegative = "I'm not saying I don't need $2,000 but I'm also not not saying I do need it";
  ...
  describe('Numerical Complexity - Format Confusion', () => {
    ...
    test('should handle mixed format in single expression', () => {
      const mixed = "I need $5,000.00 (five thousand dollars) or roughly 5k give or take";
    ...
    test('should handle currency conversion expressions', () => {
      const conversion = "I need €2,000 which is about $2,200 USD at current exchange rates";
  ...
  describe('Cultural and Multilingual Challenges', () => {
    ...
    test('should handle code-switching between languages', () => {
      const codeSwitch1 = "Mi nombre es María and I need $3,000 para medical expenses";
  ...
  describe('Semantic Paradoxes and Logical Inconsistencies', () => {
    test('should handle circular references', () => {
      const circular = "My name is Sarah who is Jennifer who is really Sarah Johnson and I need $3,000 which is actually $4,000 but call it $3,500";
    ...
    test('should handle paradoxical statements', () => {
      const paradox = "This statement is false and my name is not my name which is Sarah but also isn't Sarah and I need zero dollars but actually $2,000";
  ...
  describe('Real-World Chaotic Scenarios', () => {
    test('should handle drunk/intoxicated speech patterns', () => {
      const drunk = "Heyyy so like *hiccup* my name ish... ish... Sarah! Yeah Sarah Johnson an I neeeeed like $2,000 bucks or sssomething for uhhhh medical shtuff an its really really impor... important you know?";
    ...
    test('should handle extreme emotional distress (crying, shouting)', () => {
      const distressed = "MY NAME IS *sobbing* SARAH *crying* AND I NEED *screaming* FIVE THOUSAND DOLLARS *wailing* PLEASE HELP ME *sobbing intensifies*";
    ...
    test('should handle medical emergency with confusion', () => {
      const emergency = "I can't breathe help me my name is I think Sarah or is it Jennifer I don't know I need money hospital ambulance $3,000 or maybe more I don't know help please someone";
    ...
    test('should handle multiple speakers in one transcript', () => {
      const multiSpeaker = "[Speaker 1] My name is Sarah [Speaker 2] No I'm Sarah [Speaker 1] I need $2,000 [Speaker 2] I need $3,000 [Background] Who needs what now?";
    ...
    test('should handle poor phone connection simulation', () => {
      const poorConnection = "M- n-me -s S-rah J-hn-on an- - ne-d $-,000 f-r he-p wi-h me-ic-l b-lls";
  ...
  describe('Adversarial Input - Designed to Break Regex', () => {
    ...
    test('should handle nested patterns that could cause backtracking', () => {
      const nested = "My name is " + "a".repeat(50) + "b".repeat(50) + " and I need help";
  ...
  describe('Boundary Condition Testing', () => {
    ...
    test('should handle maximum length input', () => {
      const maxLength = "x".repeat(50000) + " My name is Sarah and I need $2,000";
  ...
  describe('Memory and Resource Management', () => {
    test('should handle rapid fire extractions without memory leak', () => {
      ...
      for (let i = 0; i < 5000; i++) {
        extractAllWithTelemetry("My name is Sarah Johnson and I need $2,000 for help");
      }
    ...
    test('should handle concurrent-like processing', () => {
      const transcripts = Array(1000).fill(null).map((_, i) => 
  ...
  describe('Quality Score Validation Under Stress', () => {
    test('should provide reasonable quality scores for chaotic input', () => {
      const chaotic = "um so like yeah my uh name is uh Sarah I think or maybe Jennifer but yeah $2000 or something around that probably";
    ...
    test('should provide high quality scores for clean input', () => {
      const clean = "My name is Sarah Johnson and I need to raise $5,000 for emergency medical expenses for my family. This is very urgent.";
...
describe('Phase 5: Pathological Performance Cases', () => {
  ...
  test('should maintain performance with cache thrashing', () => {
    ...
    const uniqueStrings = Array(10000).fill(null).map((_, i) => 
