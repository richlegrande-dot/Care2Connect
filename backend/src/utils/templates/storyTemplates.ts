...
export const STORY_TEMPLATES: Record<string, StoryTemplate> = {
  HOUSING: {
    ...
    introTemplate: '{name} is seeking support to secure stable housing and rebuild a foundation for long-term stability.',
...
Stable housing is the foundation for everything else - employment, health, and dignity. Your contribution helps create that foundation.`,
    closingTemplate: 'Every donation brings {name} closer to having a safe place to call home and the stability needed for long-term success.',
    donationPitchTemplate: '{name} is working toward stable housing. Your support helps provide the foundation needed for employment and long-term stability.',
  },
  
  FOOD: {
    titleTemplate: 'Support {name}\'s Path to Food Security',
    introTemplate: '{name} is seeking support to address food insecurity and build toward long-term stability.',
    bodyTemplate: `{description}
...
Food security is essential for health, well-being, and the ability to pursue employment and stability.`,
    closingTemplate: 'Your contribution helps provide the nutrition and support {name} needs to focus on building a better future.',
    donationPitchTemplate: '{name} is addressing food insecurity while working toward long-term stability. Your support helps meet immediate needs while building toward self-sufficiency.',
  },
  
  JOBS: {
    titleTemplate: 'Help {name} Return to Employment',
    introTemplate: '{name} is seeking support to overcome barriers to employment and rebuild financial stability.',
    bodyTemplate: `{description}
...
Employment is the path to independence and dignity. Your contribution helps remove barriers and create opportunities.`,
    closingTemplate: 'Every donation helps {name} move closer to stable employment and financial independence.',
    donationPitchTemplate: '{name} has valuable skills and is ready to work. Your support helps overcome barriers to employment and rebuild financial stability.',
  },
  
  HEALTH: {
    titleTemplate: 'Support {name}\'s Health and Recovery',
    introTemplate: '{name} is seeking support to address health challenges while working toward overall stability.',
    bodyTemplate: `{description}
...
Health is foundational to everything else. Your contribution helps address medical needs while building toward stability.`,
    closingTemplate: 'Your support helps {name} address health challenges and work toward overall well-being and stability.',
    donationPitchTemplate: '{name} is addressing health challenges while working toward stability. Your support helps ensure access to needed care and recovery.',
  },
  
  EDUCATION: {
    titleTemplate: 'Help {name} Pursue Education and Training',
    introTemplate: '{name} is seeking support to pursue education and skill development for long-term career success.',
    bodyTemplate: `{description}
...
Education and skills open doors to better opportunities. Your contribution invests in {name}'s future success.`,
    closingTemplate: 'Every donation helps {name} gain the skills and credentials needed for long-term career success.',
    donationPitchTemplate: '{name} is pursuing education and training for long-term success. Your support helps overcome financial barriers to learning.',
  },
  
  SAFETY: {
    titleTemplate: 'Help {name} Find Safety and Stability',
    introTemplate: '{name} is seeking support to move to a safe environment and rebuild stability.',
    bodyTemplate: `{description}
...
Safety is a fundamental human need. Your contribution helps provide a secure environment for healing and growth.`,
    closingTemplate: 'Your support helps {name} find safety and begin the journey toward healing and stability.',
    donationPitchTemplate: '{name} is working toward safety and stability. Your support helps provide a secure environment for healing and growth.',
  },
  
  GENERAL: {
    titleTemplate: 'Support {name}\'s Journey to Stability',
    introTemplate: '{name} is seeking support to overcome current challenges and build toward long-term stability.',
    bodyTemplate: `{description}
...
Every person deserves dignity and opportunity. Your contribution helps create pathways to stability and independence.`,
    closingTemplate: 'Every donation helps {name} move closer to stability, independence, and long-term success.',
    donationPitchTemplate: '{name} is working to overcome challenges and build toward stability. Your support provides dignity, opportunity, and hope.',
  },
};
 ...
 */
export const FALLBACK_DONATION_PITCH = 'Every contribution helps provide stability and opportunity. Your support makes a meaningful difference.';
