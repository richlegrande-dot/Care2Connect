...
export default function ProcessingOverlay({ onComplete, duration = 5000 }: ProcessingOverlayProps) {
        ...
        <div className="relative mb-12">
          <div className="bg-white shadow-2xl rounded-lg p-12 transform transition-all duration-1000 animate-slide-up">
            ...
            <div className="space-y-3 mb-8">
              <div className="h-4 bg-gray-200 rounded animate-fill-line" style={{ animationDelay: '0.2s' }} />
              <div className="h-4 bg-gray-200 rounded animate-fill-line w-3/4" style={{ animationDelay: '0.4s' }} />
            </div>
            ...
            {/* Document footer */}
            <div className="h-3 bg-gray-200 rounded animate-fill-line w-1/2" style={{ animationDelay: '1.8s' }} />
          </div>
        </div>
