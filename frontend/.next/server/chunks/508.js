  ...
  (exports.modules = {
      ...
      function l(e) {
        ...
        let [[n, o], ...s] = a(e),
          ...
          b = {
            ...
            ...(m && { secure: !0 }),
            ...(g && {
              priority: h.includes((r = (r = g).toLowerCase())) ? r : void 0,
            }),
          };
        return (function (e) {
          let t = {};
          ...
          if ((s && "object" == typeof s) || "function" == typeof s)
            for (let i of n(s))
              o.call(e, i) ||
                ...
                t(e, i, {
                  get: () => s[i],
                  enumerable: !(a = r(s, i)) || a.enumerable,
                });
          return e;
      ...
      class h {
        ...
        analyze() {
          ...
          let l = (0, i.getNextPathnameInfo)(this[u].url.pathname, {
            ...
            h = (0, s.getHostname)(this[u].url, this[u].options.headers);
          ...
          let d =
            ...
            (null == (a = this[u].options.nextConfig)
              ? void 0
              : null == (o = a.i18n)
                ? void 0
                : o.defaultLocale);
    ...
    62988: (e, t, r) => {
      ...
      class u extends Response {
        ...
        static redirect(e, t) {
          ...
          return (
            s.set("Location", (0, o.validateURL)(e)),
            new u(null, { ...n, headers: s, status: r })
          );
        }
        static rewrite(e, t) {
    ...
    92604: (e, t) => {
      function r(e) {
        ...
        for (let [r, n] of Object.entries(e)) {
          ...
          for (let n of e)
            void 0 !== n &&
              ("number" == typeof n && (n = n.toString()), t.append(r, n));
        }
        return t;
      }
      function n(e) {
        ...
        if (e)
          for (let [o, s] of e.entries())
            "set-cookie" === o.toLowerCase()
              ? (r.push(...n(s)), (t[o] = 1 === r.length ? r[0] : r))
              : (t[o] = s);
        return t;
      }
      function s(e) {
    ...
    11098: (e, t, r) => {
      ...
      function i(e, t) {
        ...
        a &&
          (0, s.pathHasPrefix)(h.pathname, a) &&
          ((h.pathname = (0, o.removePathPrefix)(h.pathname, a)),
          (h.basePath = a));
        let d = h.pathname;
        if (
