...
export default function FindMyProfilePage() {
  ...
  const validateSessionId = (id: string): boolean => {
    ...
    return cleaned.length >= 20 && cleaned.length <= 30 && /^[a-z0-9]+$/.test(cleaned);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateSessionId(cleaned)) {
      setError('Session ID should be 20-30 characters long and contain only letters and numbers.');
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Find My Profile</h1>
          <p className="text-gray-600 text-sm">
            Enter your session ID to access your stability profile and personalized roadmap.
          </p>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm text-amber-800 font-medium mb-1">Session ID Privacy</p>
              <p className="text-xs text-amber-700">
                Your session ID is your private key to your profile. Keep it safe — anyone with this ID can view your results.
        ...
        <div className="mt-8 p-4 bg-gray-50 rounded-lg">
          ...
          <ul className="space-y-1 text-xs text-gray-600">
            ...
            <li>• Your session ID is sent to you after completing the assessment</li>
          </ul>
        </div>
