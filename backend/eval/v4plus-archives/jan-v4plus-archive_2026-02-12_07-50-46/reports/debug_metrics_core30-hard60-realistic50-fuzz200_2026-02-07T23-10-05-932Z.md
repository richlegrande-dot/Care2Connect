...
Timestamp: 2026-02-07T23:10:05.935Z
...
- realistic50: category 9, urgencyOver 10, urgencyUnder 0, name 0, amountMissing 2, amountWrongSel 0, amountOutsideTol 0
...
### Urgency Over
- 000REALISTIC_13 (realistic50): CRITICAL → HIGH (gap 1)
- 000REALISTIC_20 (realistic50): CRITICAL → HIGH (gap 1)
- 000REALISTIC_23 (realistic50): CRITICAL → HIGH (gap 1)
- 000REALISTIC_24 (realistic50): CRITICAL → HIGH (gap 1)
- 000REALISTIC_26 (realistic50): CRITICAL → HIGH (gap 1)
- 000REALISTIC_32 (realistic50): HIGH → MEDIUM (gap 1)
- 000REALISTIC_47 (realistic50): MEDIUM → LOW (gap 1)
- 000REALISTIC_48 (realistic50): CRITICAL → LOW (gap 3)
- 000REALISTIC_49 (realistic50): MEDIUM → LOW (gap 1)
- 000REALISTIC_50 (realistic50): CRITICAL → LOW (gap 3)
