(() => {
  ...
  ((e.id = 466),
    ...
    (e.modules = {
                  ...
                  children: [
                    "knowledge",
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(s.bind(s, 97135)),
      ...
      70639: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 85728));
      },
      20717: (e, t, s) => {
          ...
          let j = async () => {
              ...
              try {
                let e = localStorage.getItem("adminToken"),
                  ...
                  r = await fetch(`/api/admin/knowledge/sources?${t}`, {
            ...
            N = async (e, t) => {
              if (
                confirm(
                  `Delete "${t}"? This will soft-delete the source and keep it in the database.`,
                )
              )
                try {
                  let t = localStorage.getItem("adminToken"),
                    s = await fetch(`/api/admin/knowledge/sources/${e}`, {
                      method: "DELETE",
                      headers: {
                  ...
                  s.ok ? j() : alert("Failed to delete source");
                } catch (e) {
      ...
      97135: (e, t, s) => {
        ...
        let a = (0, r.createProxy)(
            String.raw`C:\Users\richl\Care2system\frontend\app\admin\knowledge\page.tsx`,
          ),
