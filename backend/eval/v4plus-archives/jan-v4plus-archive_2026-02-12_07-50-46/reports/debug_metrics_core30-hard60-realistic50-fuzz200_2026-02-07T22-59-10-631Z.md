...
Timestamp: 2026-02-07T22:59:10.633Z
...
- hard60: category 14, urgencyOver 15, urgencyUnder 1, name 7, amountMissing 1, amountWrongSel 10, amountOutsideTol 1
...
### Urgency Over
- HARD_001 (hard60): HIGH → MEDIUM (gap 1)
- HARD_002 (hard60): CRITICAL → HIGH (gap 1)
- HARD_004 (hard60): CRITICAL → HIGH (gap 1)
- HARD_005 (hard60): CRITICAL → MEDIUM (gap 2)
- HARD_010 (hard60): HIGH → MEDIUM (gap 1)
- HARD_018 (hard60): HIGH → MEDIUM (gap 1)
- HARD_021 (hard60): CRITICAL → HIGH (gap 1)
- HARD_025 (hard60): CRITICAL → MEDIUM (gap 2)
- HARD_029 (hard60): CRITICAL → HIGH (gap 1)
- HARD_037 (hard60): HIGH → MEDIUM (gap 1)
