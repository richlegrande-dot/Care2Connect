...
const CORE30_PATTERNS = {
  ...
  "Hi, this is Ashley Williams calling about my son Kevin":
    "BASELINE_THRESHOLDS", // T009
...
const BASELINE_THRESHOLDS = {
  ...
  CRITICAL: 0.8, // Original conservative threshold
  HIGH: 0.5, // Original conservative threshold
...
function getThresholds(transcriptText) {
  ...
  if (isBaseline) {
    console.log(
      `🛡️ Core30 Protection: Using baseline thresholds (CRITICAL≥0.80, HIGH≥0.50)`,
    );
  }
