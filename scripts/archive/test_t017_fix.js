// Test T017 urgency fix with improved son/daughter surgery pattern
const testCases = [
  {
    id: "T017_Johnson",
    text: "Hello, my name is Marcus Johnson. I used to make six hundred dollars a week before I got injured at work. Now I can't work and I need help with my medical bills. The doctor says I need about four thousand five hundred dollars for the surgery.",
    expected: "HIGH"
  },
  {
    id: "Child_Surgery_My_Son", 
    text: "My son needs surgery and it costs ten thousand dollars",
    expected: "CRITICAL"
  },
  {
    id: "Child_Surgery_Direct",
    text: "My daughter needs emergency surgery tomorrow",
    expected: "CRITICAL"
  },
  {
    id: "Anderson_Surgery",
    text: "Hello, this is Jennifer Anderson. I need help with surgery costs",
    expected: "HIGH" // Should not match false positive on Anderson -> son
  }
];
...
function assessUrgencyFallback(transcript) {
  ...
  // Check CRITICAL patterns - FIXED with more precise son/daughter surgery pattern
  if (/emergency|critical|immediately|crisis|life threatening|911|ambulance|dying|death/i.test(lower) ||
      ...
      // FIXED: More precise son/daughter surgery pattern to avoid surname false positives
