(() => {
  ...
  ((e.id = 495),
    ...
    (e.modules = {
                  ...
                  children: [
                    "[id]",
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(s.bind(s, 87842)),
      ...
      86191: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 13078));
      },
      20717: (e, t, s) => {
      ...
      13078: (e, t, s) => {
        ...
        function p() {
          ...
          let B = async () => {
              (v(!0), N(""));
              try {
                let e = await u.h.checkDbHealth();
                if ((k(e.ready), !e.ready)) {
                  N("System offline due to database connectivity");
                  return;
                }
                let s = await u.h.get(`/tickets/${t}`);
                l(s);
                try {
                  let e = await u.h.get(`/tickets/${t}/donations/total`);
                  g(e);
                } catch (e) {
                  console.error("Failed to load donation totals:", e);
                }
                try {
                  let e = await u.h.get(`/tickets/${t}/donations`);
                  y(e);
                } catch (e) {
            ...
            G = async () => {
              ...
              try {
                ...
                let r = {
                    ...
                    currency: D,
                    description:
                      Z || `Support for ${s?.displayName || "profile"}`,
                  },
                  a = await u.h.post(`/tickets/${t}/create-payment`, r);
                (U(a.qrCodeBase64), _(a.checkoutUrl));
              } catch (e) {
                O(e.message || "Failed to generate donation QR code");
              } finally {
                $(!1);
              }
            },
            F = async () => {
              ($(!0), O(""));
              try {
                let e = await u.h.get(`/tickets/${t}/qr-code`);
                (U(e.qrCodeBase64), _(e.checkoutUrl), P(!0));
              } catch (e) {
                O(e.message || "No existing QR code found");
              } finally {
                $(!1);
              }
            },
                              ...
                              (0, r.jsxs)("div", {
                                children: [
                                  r.jsx("h1", {
                                    ...
                                    children:
                                      s?.displayName || "Anonymous Profile",
                                  }),
                                  r.jsx("p", {
                                                      ...
                                                      children: [
                                                        ...
                                                        r.jsx("td", {
                                                          ...
                                                          children: r.jsx(
                                                            "span",
                                                            {
                                                              className: `px-2 py-1 rounded-full text-xs font-semibold border ${Q(e.status)}`,
                                                              children:
                                                                e.status,
                                                            },
                                                          ),
      ...
      87842: (e, t, s) => {
        ...
        let a = (0, r.createProxy)(
            String.raw`C:\Users\richl\Care2system\frontend\app\profile\[id]\page.tsx`,
          ),
