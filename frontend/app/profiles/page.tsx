...
export default function ProfilesPage() {
  ...
  const [isSubmittingSupportTicket, setIsSubmittingSupportTicket] =
    useState(false);
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${apiBaseUrl}/api/story/${searchQuery.trim()}/status`,
      );
      ...
      if (!response.ok) {
        ...
        const ticketResponse = await fetch(
          `${apiBaseUrl}/api/profile/${searchQuery.trim()}`,
        );
        let ticketData = null;
        ...
        setSearchResults([
          {
            ...
            qrCodeUrl: data.assetsReady
              ? `${apiBaseUrl}/api/profile/${searchQuery.trim()}/qrcode.png`
              : undefined,
            gofundmeDraftUrl: data.assetsReady
              ? `${apiBaseUrl}/api/profile/${searchQuery.trim()}/gofundme-draft.docx`
              : undefined,
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="mt-4 text-sm text-gray-500">
            <p>
              <strong>Tip:</strong> Your ticket ID was provided after you
              recorded your story. Check your email or notes.
            </p>
          </div>
        </div>
        ...
        {searchQuery && searchResults.length === 0 && !isSearching && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              We couldn't find a profile with that ticket ID. Please check the
              ID and try again.
            </p>
            <Link
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600">
                Having trouble finding your profile or experiencing issues?
            ...
            <div className="mt-6 space-y-4 border-t pt-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="cannot-find-profile">
                    Can't Find My Profile
                  </option>
                  <option value="processing-stuck">
                    Processing Stuck/Failed
                  </option>
                  <option value="missing-assets">
                    Missing QR Code or Document
                  </option>
