...
describe("TranscriptSignalExtractor", () => {
  describe("extractSignals", () => {
    ...
    it("should categorize housing needs correctly", async () => {
      ...
      const housingCategory = signals.needsCategories.find(
    ...
    it("should handle safety/escape needs", async () => {
      ...
      const safetyCategory = signals.needsCategories.find(
        (c) => c.category === "SAFETY",
      );
    ...
    it("should handle medical/healthcare needs", async () => {
      ...
      const healthcareCategory = signals.needsCategories.find(
    ...
    it("should handle addiction recovery needs", async () => {
      ...
      const addictionCategory = signals.needsCategories.find(
        (c) => c.category === "ADDICTION",
      );
    ...
    it("should extract childcare needs", async () => {
      ...
      const childcareCategory = signals.needsCategories.find(
        (c) => c.category === "CHILDCARE",
      );
    ...
    it("should extract transportation needs", async () => {
      ...
      const transportationCategory = signals.needsCategories.find(
