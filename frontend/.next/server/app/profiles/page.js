(() => {
  ...
  ((e.id = 403),
    ...
    (e.modules = {
              ...
              children: [
                "profiles",
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(r.bind(r, 95107)),
      ...
      56186: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 79401));
      },
      20717: (e, t, r) => {
      ...
      79401: (e, t, r) => {
        ...
        var s = r(73658),
          ...
          d = r(28098),
          c = r(6561);
        let u = a.forwardRef(function ({ title: e, titleId: t, ...r }, s) {
        ...
        var m = r(33999),
          x = r(84874),
          h = r.n(x);
        let p = () => "https://api.care2connects.org";
        function g() {
          let e = (0, n.useRouter)(),
            [t, r] = (0, a.useState)(""),
            [x, g] = (0, a.useState)([]),
            ...
            D = async () => {
              ...
              try {
                let e = p(),
                  r = await fetch(`${e}/api/story/${t.trim()}/status`);
                if (r.ok) {
                  let s = await r.json(),
                    a = await fetch(`${e}/api/profile/${t.trim()}`),
                    n = null;
                  (a.ok && (n = await a.json()),
                    g([
                      {
                        ...
                        qrCodeUrl: s.assetsReady
                          ? `${e}/api/profile/${t.trim()}/qrcode.png`
                          : void 0,
                        gofundmeDraftUrl: s.assetsReady
                          ? `${e}/api/profile/${t.trim()}/gofundme-draft.docx`
                          : void 0,
                        story: n?.story,
                      },
                    ]),
            ...
            O = async () => {
              ...
              try {
                let e = p(),
                  t = await fetch(`${e}/api/support/ticket`, {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({
                      ticketId: P.trim() || null,
                      category: v,
                      message: N,
                      contact: C.trim() || null,
                      systemSnapshot: {
            ...
            T = (e) => {
              switch (e) {
                case "COMPLETED":
                  return s.jsx(i.Z, { className: "w-6 h-6 text-green-500" });
                case "FAILED":
                  return s.jsx(l.Z, { className: "w-6 h-6 text-red-500" });
                case "PROCESSING":
                case "TRANSCRIBING":
                case "ANALYZING":
                case "GENERATING_QR":
                ...
                default:
                  return s.jsx(d.Z, { className: "w-6 h-6 text-gray-400" });
              }
            },
            L = (e) =>
              ({
                      ...
                      children: [
                        ...
                        s.jsx("button", {
                          ...
                          children: f
                            ...
                            : (0, s.jsxs)(s.Fragment, {
                                children: [
                                  s.jsx(c.Z, { className: "w-5 h-5 mr-2" }),
                                  "Search",
                                ],
                              }),
                        }),
                                      ...
                                      children: [
                                        ...
                                        (0, s.jsxs)("p", {
                                          children: [
                                            ...
                                            " ",
                                            s.jsx("span", {
                                              className: `font-medium ${"COMPLETED" === e.status ? "text-green-600" : "FAILED" === e.status ? "text-red-600" : "text-yellow-600"}`,
                                              children: L(e.status),
                                            }),
                                          ],
                                        }),
                          ...
                          (0, s.jsxs)("div", {
                            ...
                            children: [
                              s.jsx("button", {
                                ...
                                children: A ? "Submitting..." : "Submit Ticket",
                              }),
                              s.jsx("button", {
                                onClick: () => j(!1),
                                className:
      ...
      18685: (e, t, r) => {
        "use strict";
        (r.r(t), r.d(t, { default: () => f, metadata: () => g }));
        var s = r(31487),
          a = r(72972),
          n = r.n(a);
        r(40642);
      ...
      95107: (e, t, r) => {
        "use strict";
        (r.r(t),
          r.d(t, { $$typeof: () => i, __esModule: () => n, default: () => o }));
        var s = r(19894);
        let a = (0, s.createProxy)(
            String.raw`C:\Users\richl\Care2system\frontend\app\profiles\page.tsx`,
          ),
