...
const TASK_LIBRARY: TaskTemplate[] = [
...

  {
    ...
    description:
      "Call the National Domestic Violence Hotline (1-800-799-7233) or local DV shelter for immediate safe placement.",
    priority: "critical",
  ...
  },
  {
    ...
    description:
      "Call the National Human Trafficking Hotline (1-888-373-7888) for immediate assistance.",
    priority: "critical",
    resourceTypes: ["crisis_hotline", "legal_aid"],
    triggers: [
      { field: "safety.fleeing_trafficking", operator: "eq", value: true },
    ],
  },
  {
    ...
    description:
      "Connect with a crisis counselor immediately. Call or text 988.",
    priority: "critical",
    resourceTypes: ["crisis_hotline", "mental_health"],
    triggers: [
      { field: "safety.suicidal_ideation_recent", operator: "eq", value: true },
    ],
  },
  {
    id: "imm-shelter-bed",
    ...
    description:
      "Search for emergency shelter availability in the client's area.",
    priority: "critical",
    resourceTypes: ["shelter"],
    triggers: [
      {
        field: "housing.current_living_situation",
        operator: "eq",
        value: "unsheltered",
      },
    ],
  },
  {
    ...
    description:
      "Connect with nearest emergency room, urgent care, or mobile health unit.",
    priority: "critical",
    resourceTypes: ["healthcare", "emergency_services"],
    triggers: [
      { field: "health.needs_immediate_medical", operator: "eq", value: true },
    ],
  },
  {
    ...
    description:
      "Contact pharmacy assistance programs or community health center for emergency medication supply.",
    priority: "high",
    resourceTypes: ["healthcare", "pharmacy"],
    triggers: [
      { field: "health.needs_medication", operator: "eq", value: true },
      {
        field: "health.has_access_to_medication",
        operator: "eq",
        value: false,
      },
    ],
  },
  {
    ...
    description:
      "Work with case manager to develop an immediate safety plan addressing current threats.",
    priority: "high",
    resourceTypes: ["case_management"],
    triggers: [
      {
        field: "safety.experienced_violence_recently",
        operator: "eq",
        value: true,
      },
    ],
  },
  {
    ...
    description:
      "Arrange crisis intervention or emergency psychiatric evaluation.",
    priority: "critical",
    resourceTypes: ["mental_health", "crisis_hotline"],
    triggers: [
      {
        field: "safety.mental_health_current",
        operator: "eq",
        value: "severe_crisis",
      },
    ],
...

  {
    ...
    description:
      "Help navigate DMV requirements and fee waiver programs for obtaining government-issued ID.",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Complete Medicaid application or explore marketplace options during open enrollment.",
    priority: "high",
    resourceTypes: ["healthcare", "benefits_enrollment"],
    triggers: [
      { field: "health.has_health_insurance", operator: "eq", value: false },
    ],
  },
  {
    ...
    description:
      "Complete benefits screening and assist with applications for eligible programs.",
    priority: "high",
    resourceTypes: ["benefits_enrollment", "case_management"],
    triggers: [
      { field: "income.has_any_income", operator: "eq", value: false },
    ],
  },
  {
    ...
    description:
      "Identify and refer to appropriate treatment program (outpatient, inpatient, MAT).",
    priority: "high",
    resourceTypes: ["substance_treatment", "mental_health"],
    triggers: [
      {
        field: "safety.substance_use_current",
        operator: "eq",
        value: "seeking_treatment",
      },
    ],
  },
  {
    ...
    description:
      "Refer to legal aid for eviction defense, tenant rights, or emergency rental assistance.",
    priority: "high",
    resourceTypes: ["legal_aid", "financial_assistance"],
    triggers: [
      { field: "housing.eviction_notice", operator: "eq", value: true },
    ],
  },
  {
    ...
    description:
      "Contact local VA office, SSVF program, or HUD-VASH for veteran-specific housing and services.",
    priority: "high",
    resourceTypes: ["veterans_services", "housing"],
    triggers: [
      { field: "demographics.veteran_status", operator: "eq", value: true },
    ],
  },
  {
    id: "st-prenatal-care",
    ...
    description:
      "Connect with OB/GYN services, WIC program, and prenatal nutrition support.",
    priority: "high",
    resourceTypes: ["healthcare", "wic"],
    triggers: [
      { field: "health.currently_pregnant", operator: "eq", value: true },
    ],
  },
  {
    ...
    description:
      "Identify food banks, community meals, SNAP enrollment, and other food assistance.",
    priority: "medium",
    resourceTypes: ["food", "benefits_enrollment"],
    triggers: [
      { field: "goals.top_priorities", operator: "includes", value: "food" },
    ],
  },
...

  {
    ...
    description:
      "Enroll in vocational training, resume workshops, or job placement services.",
    priority: "medium",
    resourceTypes: ["job_training", "employment"],
    triggers: [
      { field: "income.wants_employment_help", operator: "eq", value: true },
    ],
  },
  {
    ...
    description:
      "Apply for rapid re-housing program with rental assistance and case management support.",
    priority: "high",
    resourceTypes: ["housing", "case_management"],
    triggers: [
      {
        field: "goals.housing_preference",
        operator: "in",
        value: ["rapid_rehousing", "any_available"],
      },
    ],
  },
  {
    ...
    description:
      "Apply for PSH program for long-term housing with wraparound services.",
    priority: "high",
    resourceTypes: ["housing", "case_management"],
    triggers: [
      {
  ...
  },
  {
    ...
    description:
      "Connect with legal aid to explore record expungement or sealing options.",
    priority: "medium",
    resourceTypes: ["legal_aid"],
    triggers: [
      {
        field: "goals.barriers_to_housing",
        operator: "includes",
  ...
  },
  {
    ...
    description:
      "Connect with financial literacy program and credit counseling services.",
    priority: "medium",
  ...
  },
  {
    ...
    description:
      "Connect with adult education, GED programs, or community college enrollment.",
    priority: "low",
    resourceTypes: ["education"],
    triggers: [
      {
        field: "goals.top_priorities",
        operator: "includes",
        value: "education",
      },
    ],
  },
  {
    ...
    description:
      "Connect with subsidized childcare programs, Head Start, or after-school programs.",
    priority: "medium",
  ...
  },
  {
    ...
    description:
      "Connect with transit passes, ride assistance, or vehicle donation programs.",
    priority: "low",
  ...
  },
  {
    ...
    description:
      "Connect with debt management services, bankruptcy counseling, or payment plan negotiation.",
    priority: "medium",
    resourceTypes: ["financial_counseling", "legal_aid"],
    triggers: [
      {
        field: "income.owes_debt_preventing_housing",
        operator: "eq",
        value: true,
      },
    ],
...

  {
    ...
    description:
      "Contact local anti-trafficking organizations for emergency safe housing placement.",
    priority: "critical",
  ...
  },
  {
    ...
    description:
      "Arrange short-term hotel/motel placement when shelter beds are unavailable or inappropriate.",
    priority: "high",
    ...
    triggers: [
      {
        field: "housing.current_living_situation",
        operator: "in",
        value: ["unsheltered", "vehicle", "encampment"],
      },
    ],
  },
  {
    ...
    description:
      "Connect with courthouse victim advocate to file for an emergency protective/restraining order.",
    priority: "critical",
  ...
  },
  {
    ...
    description:
      "Locate and arrange admission to detox facility for safe withdrawal management.",
    priority: "critical",
  ...
  },
  {
    ...
    description:
      "Introduce client directly to an on-site or mobile crisis navigator for immediate support.",
    priority: "high",
...

  {
    ...
    description:
      "Identify and submit applications to transitional housing programs with supportive services.",
    priority: "high",
    resourceTypes: ["housing", "case_management"],
    triggers: [
      {
        field: "housing.current_living_situation",
        operator: "in",
        value: ["shelter", "couch_surfing", "temporary"],
      },
    ],
  },
  {
    ...
    description:
      "Screen for LIHEAP and local utility assistance programs to prevent service disconnection.",
    priority: "medium",
  ...
  },
  {
    ...
    description:
      "Refer to immigration attorney or legal aid organization for status-related housing barriers.",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Assist with SSI/SSDI application or Social Security retirement benefits enrollment.",
    priority: "high",
    resourceTypes: ["benefits_enrollment", "case_management"],
  ...
  },
  {
    ...
    description:
      "Refer to disability services office for accommodations, assistive technology, and benefits navigation.",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Connect with clothing closets, hygiene kit distribution, and laundry access programs.",
    priority: "medium",
    ...
    triggers: [
      {
        field: "housing.current_living_situation",
        operator: "in",
        value: ["unsheltered", "vehicle", "encampment", "shelter"],
      },
    ],
  },
  {
    ...
    description:
      "Enroll in FCC Lifeline program for free or discounted phone service to maintain contacts.",
    priority: "medium",
  ...
  },
  {
    ...
    description:
      "Connect with outpatient therapist, psychiatric prescriber, or community mental health center.",
    priority: "high",
    resourceTypes: ["mental_health", "healthcare"],
    triggers: [
      { field: "health.mental_health_needs", operator: "eq", value: true },
    ],
  },
  {
    id: "st-peer-support",
    ...
    description:
      "Match with certified peer support specialist who has lived experience with homelessness.",
    priority: "medium",
    resourceTypes: ["peer_support", "case_management"],
    triggers: [
      { field: "history.total_months_homeless", operator: "gte", value: 12 },
    ],
  },
  {
    id: "st-mail-address",
    ...
    description:
      "Arrange a stable mailing address through shelter mail, PO Box, or day center mail service.",
    priority: "medium",
  ...
  },
  {
    ...
    description:
      "Contact school district McKinney-Vento liaison to ensure children maintain enrollment and transportation.",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Meet with DV advocate for detailed safety planning: escape routes, code words, document copies, financial separation.",
    priority: "high",
...

  {
    ...
    description:
      "Submit applications to local housing authority waitlists, Section 8 voucher programs, and project-based housing.",
    priority: "high",
    ...
    triggers: [
      {
        field: "goals.housing_preference",
        operator: "in",
        value: ["voucher", "section_8", "any_available"],
      },
    ],
  },
  {
    ...
    description:
      "Assess eligibility for relocation programs to areas with lower cost of living or family support.",
    priority: "medium",
    resourceTypes: ["housing", "financial_assistance"],
    triggers: [
      { field: "goals.open_to_relocation", operator: "eq", value: true },
    ],
  },
  {
    ...
    description:
      "Connect with family mediation, child welfare liaison, and reunification support programs.",
    priority: "medium",
  ...
  },
  {
    ...
    description:
      "Connect with parenting classes, family support centers, and home visiting programs.",
    priority: "low",
  ...
  },
  {
    ...
    description:
      "Refer to Area Agency on Aging for meals, transportation, senior housing, and in-home support.",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Enroll in transitional living program for youth aging out of foster care. Includes housing, mentoring, life skills.",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Connect with fair housing organization or legal aid for discrimination complaints and tenant rights.",
    priority: "medium",
    resourceTypes: ["legal_aid"],
    triggers: [
      {
  ...
  },
  {
    ...
    description:
      "Connect with Individual Development Account program to build savings for housing deposit or education.",
    priority: "low",
    resourceTypes: ["financial_counseling"],
  ...
  },
  {
    ...
    description:
      "Connect with recovery community organization, sober living, AA/NA meetings, and recovery coaching.",
    priority: "medium",
    ...
    triggers: [
      {
        field: "safety.substance_use_current",
        operator: "in",
        value: ["in_recovery", "seeking_treatment"],
      },
    ],
  },
  {
    ...
    description:
      "Enroll in DV survivor support group, individual therapy, and long-term safety planning.",
    priority: "medium",
  ...
  },
  {
    ...
    description:
      "Connect with Workforce Innovation and Opportunity Act (WIOA) programs for training and job placement.",
    priority: "medium",
    resourceTypes: ["job_training", "employment"],
    triggers: [
      {
        field: "income.employment_status",
        operator: "in",
        value: ["unemployed", "underemployed"],
      },
    ],
  },
  {
    ...
    description:
      "Connect with FQHC or community health center for ongoing primary care, prescriptions, and preventive health.",
    priority: "medium",
    resourceTypes: ["healthcare"],
    triggers: [
      { field: "health.has_primary_care", operator: "eq", value: false },
    ],
  },
];
...
export function generatePlan(data: IntakeData): ActionPlanResult {
  ...
  return {
    ...
    taskCount:
      immediateTasks.length + shortTermTasks.length + mediumTermTasks.length,
  };
}
