(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    4962: function (e, t, r) {
      Promise.resolve().then(r.bind(r, 71498));
    },
    71498: function (e, t, r) {
      ...
      var a = r(37821),
        ...
        n = r.n(i),
        l = r(97485);
      let c = s.forwardRef(function ({ title: e, titleId: t, ...r }, a) {
        ...
        d = s.forwardRef(function ({ title: e, titleId: t, ...r }, a) {
          return s.createElement(
            "svg",
            Object.assign(
              {
      ...
      function p() {
        ...
        let O = async () => {
            try {
              let e = await fetch(
                  "".concat("https://api.care2connects.org", "/api/qr/status"),
                ),
                t = await e.json();
              t.success && C(t.data.configured);
            } catch (e) {
          ...
          $ = (e) => {
            f(e);
            let t = parseFloat(e);
            !isNaN(t) && t > 0 ? i(t) : i(null);
          },
          _ = async (e) => {
            if ((e.preventDefault(), !r || r < 0.5)) {
              l.default.error("Minimum donation amount is $0.50");
              return;
            }
            if (!E) {
              l.default.error(
            ...
            try {
              let e = await fetch(
                ...
                a = await e.json();
              a.success
                ? (window.location.href = a.data.checkoutUrl)
                : l.default.error(
                    a.error || "Failed to create checkout session",
                  );
            } catch (e) {
              ...
              children: (0, a.jsx)("div", {
                ...
                children: (0, a.jsxs)(n(), {
                  ...
                  children: [
                    ...
                    (0, a.jsx)("span", { children: "Back to CareConnect" }),
                  ],
                }),
              }),
            }),
                                ...
                                (0, a.jsxs)("div", {
                                  ...
                                  children: [
                                    (0, a.jsxs)("span", {
                                      children: [
                                        "$",
                                        (N.amountRaised || 0).toLocaleString(),
                                        " raised",
                                      ],
                                    }),
                                    (0, a.jsxs)("span", {
                                ...
                                children: m.map((e) => {
                                  ...
                                  return (0, a.jsx)(
                                    "button",
                                    {
                                      ...
                                      onClick: () => S(t),
                                      className:
                                        "p-3 rounded-lg border-2 font-semibold transition-all ".concat(
                                          r !== t || w
                              ...
                              (0, a.jsxs)("div", {
                                children: [
                                  ...
                                  (0, a.jsx)("p", {
                                    ...
                                    children: "For donation receipt (optional)",
                                  }),
                                ],
                              }),
                              (0, a.jsxs)("div", {
    ...
    97485: function (e, t, r) {
      ...
      var N = (e) => "function" == typeof e,
        ...
        $ = [],
        _ = { toasts: [], pausedAt: void 0, settings: { toastLimit: 20 } },
        D = {},
        A = (e, t = O) => {
          ((D[t] = S(D[t] || _, e)),
            $.forEach(([e, r]) => {
        ...
        L = (e) => Object.keys(D).forEach((t) => A(e, t)),
        P = (e) =>
        ...
        F = (e) => (t, r) => {
          let a = R(t, e, r);
          return (T(a.toasterId || P(a.id))({ type: 2, toast: a }), a.id);
        },
        z = (e, t) => F("blank")(e, t);
      ((z.error = F("error")),
        (z.success = F("success")),
      ...
      var B = 1e3,
        H = (e, t = "default") => {
          let { toasts: r, pausedAt: a } = M(e, t),
            s = (0, i.useRef)(new Map()).current,
            o = (0, i.useCallback)((e, t = B) => {
              if (s.has(e)) return;
              let r = setTimeout(() => {
          ...
          (0, i.useEffect)(() => {
            ...
            let e = Date.now(),
              s = r.map((r) => {
                ...
                if (a < 0) {
                  r.visible && z.dismiss(r.id);
                  return;
                }
                return setTimeout(() => z.dismiss(r.id, t), a);
              });
            return () => {
              s.forEach((e) => e && clearTimeout(e));
            };
          }, [r, a, t]);
          let n = (0, i.useCallback)(T(t), [t]),
            l = (0, i.useCallback)(() => {
