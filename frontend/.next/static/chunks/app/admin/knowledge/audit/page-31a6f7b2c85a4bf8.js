(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [987],
  {
    56499: function (e, t, s) {
      Promise.resolve().then(s.bind(s, 23692));
    },
    23692: function (e, t, s) {
      ...
      function l() {
        let e = (0, n.useRouter)(),
          ...
          [p, y] = (0, r.useState)(
            (null == t ? void 0 : t.get("action")) || "",
          ),
          [b, f] = (0, r.useState)(
            (null == t ? void 0 : t.get("entityType")) || "",
          ),
          [j, v] = (0, r.useState)(
            (null == t ? void 0 : t.get("entityId")) || "",
          );
        (0, r.useEffect)(() => {
          (N(), w());
        }, [o, p, b, j]);
        let N = async () => {
            ...
            try {
              let e = localStorage.getItem("adminToken"),
                ...
                s = await fetch("/api/admin/knowledge/audit?".concat(t), {
        ...
        let u = async (e) => {
          ...
          h = async (e) => {
            ...
            try {
              ...
              e.ok
                ? (localStorage.setItem("adminToken", c), i(!0), o(""))
                ...
                children: [
                  (0, a.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, a.jsx)("button", {
                        onClick: () => {
                          (localStorage.removeItem("adminToken"), i(!1), o(""));
                        },
                        className:
    ...
    8489: function (e, t, s) {
      ...
      function c(e, t, s) {
        ...
        t))
          i.call(t, a) && !d.hasOwnProperty(a) && (n[a] = t[a]);
        if (e && e.defaultProps)
