...
describe('Incident Store Operations', () => {
...
describe('Port and Configuration Validation', () => {
  ...
  it('should ensure frontend points to correct backend port', () => {
    ...
    const frontendApiUrl = process.env.NEXT_PUBLIC_API_URL || `http://localhost:${backendPort}`;
