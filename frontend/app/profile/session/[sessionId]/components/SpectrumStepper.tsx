...
const LEVELS: { level: number; label: string; color: string; bgColor: string; borderColor: string; ringColor: string }[] = [
  { level: 0, label: 'Crisis',           color: 'text-red-700',    bgColor: 'bg-red-600',    borderColor: 'border-red-600',    ringColor: 'ring-red-300' },
  { level: 1, label: 'Severe Risk',      color: 'text-red-600',    bgColor: 'bg-red-500',    borderColor: 'border-red-500',    ringColor: 'ring-red-200' },
  { level: 2, label: 'High Risk',        color: 'text-orange-600', bgColor: 'bg-orange-500', borderColor: 'border-orange-500', ringColor: 'ring-orange-200' },
  { level: 3, label: 'Moderate Risk',    color: 'text-yellow-600', bgColor: 'bg-yellow-500', borderColor: 'border-yellow-500', ringColor: 'ring-yellow-200' },
  { level: 4, label: 'Low Risk',         color: 'text-green-600',  bgColor: 'bg-green-500',  borderColor: 'border-green-500',  ringColor: 'ring-green-200' },
  { level: 5, label: 'Stable',           color: 'text-emerald-600',bgColor: 'bg-emerald-500',borderColor: 'border-emerald-600',ringColor: 'ring-emerald-200' },
];

export default function SpectrumStepper({ currentLevel }: SpectrumStepperProps) {
  ...
  return (
    <div className="w-full">
      ...
      <p className="text-sm text-gray-500 mb-6">
        ...
        Each level represents a stage — from crisis to stable.
      </p>
