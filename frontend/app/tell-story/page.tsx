  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const userResponse = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/auth/anonymous`,
        {
          method: "POST",
          headers: {
      ...
      await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/auth/update-consent`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <ul className="text-blue-800 space-y-1 text-sm">
                      ...
                      <li>
                        • Your story helps create a personalized profile with
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="consent" className="text-gray-700">
                    ...
                    <ul className="mt-2 text-sm text-gray-600 space-y-1">
                      ...
                      <li>
                        • I retain full control over my data and can delete it
                        anytime
                      </li>
                    </ul>
                  </label>
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="public" className="text-gray-700">
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                      ...
                      potential donors and supporters find me, but you can
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              ...
              helps us connect you with the right resources and opportunities.
            </p>
            ...
            {audioBlob && (
              <div className="pt-8 border-t border-gray-200">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  This will transcribe your audio and create your personalized
                  profile
                </p>
              </div>
            )}
