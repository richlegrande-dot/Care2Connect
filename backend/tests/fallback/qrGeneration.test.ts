...
import { createPaymentQRWithMode, generateQRFromManualDraft } from '../../src/services/qrCodeGeneratorEnhanced';
...
describe('QR Code Generator Enhanced', () => {
  ...
  beforeEach(async () => {
    ...
    await prisma.recordingTicket.createMany({
      data: [
        { id: 'test-qr-auto-001', contactType: 'EMAIL', contactValue: 'auto@test.com', status: 'DRAFT' },
        { id: 'test-qr-manual-001', contactType: 'EMAIL', contactValue: 'manual@test.com', status: 'DRAFT' },
        { id: 'test-qr-manual-draft-123', contactType: 'EMAIL', contactValue: 'draft@test.com', status: 'DRAFT' }
      ]
    });
  });
