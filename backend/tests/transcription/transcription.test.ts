...
(RUN ? describe : describe.skip)("Transcription Service Tests", () => {
  ...
  describe("POST /api/transcription/text", () => {
    it("should process manual transcript successfully", async () => {
      const testTranscript =
        "My name is John Smith. I am experiencing homelessness and need help with housing. I have work experience in construction and am looking for stable employment. My goal is to raise $5000 to get back on my feet and find permanent housing.";
  ...
  describe("Data Protection", () => {
    it("should block sensitive information", async () => {
      const sensitiveTranscript =
        "My name is John. My SSN is 123-45-6789 and my bank account is 987654321. I need help with housing.";
